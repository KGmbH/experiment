...
const post_test_customized = magpieViews.view_generator(
  ...
  title: 'Weitere Informationen',
    text: 'Diese Angaben sind komplett freiwillig, helfen mir allerdings bei der Auswertung der Ergebnisse. Bitte klicken Sie zuletzt unbedingt unten auf "WEITER", da Ihre Daten sonst nicht gespeichert werden. <b> Um eine bessere Überprüfbarkeit der Ergebnisse zu ermöglichen, würde ich mich sehr freuen, wenn Sie in zwei Wochen erneut an diesem Experiment teilnehmen würden. </b> <b> Damit Ihre beiden Experimentteilnahmen bei meiner Auswertung miteinander verknüpft werden können, bitte ich Sie, im Kommentarfeld einen Code einzugeben, der sich folgendermaßen zusammensetzt: 2. und 3. Buchstabe Ihres Vornamens + 2. udn 3. Buchstabe des Vornamens Ihrer Mutter.</b> <b> Beispiel: Ihr Vorname lautet Mika, der Vorname Ihrer Mutter lautet Susi. Der Code lautet dann IKUS.</b>',
